...
def build_engine(cfg: AgentConfig) -> RLMEngine:
    tools = WorkspaceTools(
        ...
        mistral_document_ai_api_key=cfg.mistral_document_ai_api_key,
        mistral_document_ai_use_shared_key=cfg.mistral_document_ai_use_shared_key,
        mistral_document_ai_base_url=cfg.mistral_document_ai_base_url,
        mistral_document_ai_ocr_model=cfg.mistral_document_ai_ocr_model,
        mistral_document_ai_qa_model=cfg.mistral_document_ai_qa_model,
        mistral_document_ai_max_bytes=cfg.mistral_document_ai_max_bytes,
        mistral_document_ai_request_timeout_sec=cfg.mistral_document_ai_request_timeout_sec,
