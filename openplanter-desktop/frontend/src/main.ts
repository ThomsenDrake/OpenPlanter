...
async function init() {
  ...
  try {
    ...
    appState.update((s) => ({
      ...
      obsidianExportEnabled: config.obsidian_export_enabled,
      obsidianExportRoot: config.obsidian_export_root,
      obsidianExportMode: config.obsidian_export_mode,
      obsidianExportSubdir: config.obsidian_export_subdir,
      obsidianGenerateCanvas: config.obsidian_generate_canvas,
    ...
    messages: [
      ...
      },
      {
        ...
        content: [
          ...
          `obsidian: ${state.obsidianExportEnabled ? "enabled" : "disabled"}`,
