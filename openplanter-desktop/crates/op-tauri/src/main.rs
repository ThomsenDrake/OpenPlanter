...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::obsidian::get_obsidian_export_status,
            commands::obsidian::configure_obsidian_export,
            commands::obsidian::export_obsidian_investigation,
            commands::obsidian::open_obsidian_investigation,
            commands::orchestrator::orchestrator_start,
            commands::orchestrator::orchestrator_stop,
            commands::orchestrator::orchestrator_snapshot,
